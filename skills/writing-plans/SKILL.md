...
1. Read `plan-document-reviewer-prompt.md` as a self-review checklist
2. Apply it to the written plan document; write findings to `.llm/reviews/plan-review.md`
3. If ❌ Issues Found: fix the issues, re-apply checklist, update the file
4. If ✅ Approved: proceed to execution handoff

**Review loop guidance (both paths):**
