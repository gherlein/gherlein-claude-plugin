...
1. Read `spec-document-reviewer-prompt.md` as a self-review checklist
2. Apply it to the written spec document; write findings inline or to `.llm/reviews/spec-review.md`
3. If Issues Found: fix, re-apply checklist, repeat until Approved
